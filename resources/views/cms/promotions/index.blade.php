            ...
            <div class="divide-y divide-[#e5dbcf]">
                @forelse ($promotions as $promotion)
                    <div class="grid grid-cols-[2fr_1fr_1fr] gap-4 px-5 py-5 items-center">
                        <div>
                            <p class="font-['Host_Grotesk'] font-bold text-[16px] text-[#241810]">{{ $promotion->title }}</p>
                            <p class="mt-1 text-[14px] text-[#5d4a3d]">{{ Str::limit($promotion->description, 60) }}</p>
                        </div>
