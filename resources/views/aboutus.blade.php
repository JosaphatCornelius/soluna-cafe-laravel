    ...
    <div id="scroll-container" class="md:col-span-9 h-144 overflow-y-scroll snap-y snap-mandatory no-scrollbar md:pl-8">
        ...
        <section id="story" class="h-full w-full flex flex-col justify-center snap-start pb-12">
          <div class="max-w-xl">
              ...
              <blockquote class="italic text-3xl md:text-2xl font-tulisan mb-8 leading-relaxed tracking-wide">
                  "Didirikan pada 12 Desember 2012, Soluna Cafe lahir dari hasrat sederhana akan kopi yang luar biasa dan komunitas."
              </blockquote>
              
              <p class="text-base md:text-lg leading-relaxed text-justify">
                  Kisah kami dimulai pada 12 Desember 2012, lahir dari hasrat yang mendalam akan cita 
                  rasa otentik dan seni keramahan. Apa yang dimulai sebagai visi untuk 
                  menciptakan tempat peristirahatan komunitas yang sempurna telah berkembang 
                  menjadi Soluna Cafe, tempat di mana setiap sudut menceritakan sebuah kisah 
                  dan setiap tamu diperlakukan seperti keluarga. Sejak hari pertama kami, kami 
                  tetap berkomitmen pada gagasan bahwa sebuah kafe seharusnya lebih dari sekadar 
                  tempat makan—itu seharusnya menjadi sebuah pengalaman.
              </p>
        ...
        <section id="chef" class="h-full w-full flex flex-col justify-center snap-start relative pb-12">
            <div class= "max-w-2xl">
                ...
                <h3 class="font-bold mb:4 text-2xl ">Dedikasi, Pengalaman, dan Cita Rasa High-Class.</h3>       
                <p class="text-base md:text-lg leading-relaxed text-justify mb:6" >Dengan pengalaman lebih dari 67 tahun di industri kuliner skala 
                    internasional, Chef Kevin Kristianto membawa keahlian mendalam dan filosofi memasak 
                    yang autentik ke dapur kami. Sebelum memimpin tim kuliner kami, beliau telah mengasah 
                    bakatnya di Cafe Batavia. Rekam jejak ini membentuk standar kerja beliau yang tanpa kompromi 
                    dalam hal rasa, kebersihan, dan estetika presentasi piring.</p>      
        ...
        <section id= "awards" class="h-full w-full justify-center snap-start relative pb-12">
          <h1 class="text-3xl font-bold mb-15 space-y-2 max-w-xs">Awards yang berhasil didapatkan:</h1>
          
            <li class="flex items-center justify-between">• Salon Cullinaire 2019 by ACP - FHI</li>
            <li class="flex items-center justify-between">• Tea Cocktail - Gold Medal </li>
            <li class="flex items-center justify-between">• Beef Challange- Silver Medal</li>
            <li class="flex items-center justify-between">• Pan Fried Noodle- Diploma Award</li>
            <li class="flex items-center justify-between">• US Potatoes- Diploma Award</li>
